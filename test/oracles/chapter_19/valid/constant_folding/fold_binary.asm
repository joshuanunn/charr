(Asm.Program
   [Asm.Function {name = "target_add"; global = true;
      instructions =
      [Asm.Mov {typ = Asm.Longword; src = (Asm.Imm 300L);
         dst = (Asm.Reg Asm.AX)};
        Asm.Ret];
      frame =
      Env.lenv {
     ...
     Asm.Function {name = "target_div"; global = true;
       instructions =
       [Asm.Mov {typ = Asm.Longword; src = (Asm.Imm 277L);
          dst = (Asm.Reg Asm.AX)};
         Asm.Ret];
       frame =
       Env.lenv {
     ...
     Asm.Function {name = "main"; global = true;
       ...
       [Asm.Binary {op = Asm.Sub; typ = Asm.Quadword; src = (Asm.Imm 128L);
         ...
         Asm.Mov {typ = Asm.Longword; src = (Asm.Reg Asm.R10);
           dst = (Asm.Stack -16)};
         Asm.Unary {op = Asm.Neg; typ = Asm.Longword; dst = (Asm.Stack -16)};
         ...
         Asm.Mov {typ = Asm.Longword; src = (Asm.Imm 17L);
           dst = (Asm.Reg Asm.AX)};
         Asm.Ret; (Asm.Label "main.if.en.45");
         Asm.Mov {typ = Asm.Longword; src = (Asm.Imm 0L);
           dst = (Asm.Reg Asm.AX)};
         Asm.Ret];
       frame =
     ...
     Asm.StaticVariable {name = "val_to_negate"; global = true;
       alignment = 4; init = (Ctype.IntInit 2147483645l)}
     ])
