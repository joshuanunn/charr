(Asm.Program
   [Asm.Function {name = "switch_on_uint"; global = true;
      instructions =
      ...
      frame =
      Env.lenv {
        namespace = "switch_on_uint";
        counter = 3;
        offset = -16;
        stack slots = {
          ui.0                 -> -4,
          switch_on_uint.tmp.0 -> -8,
          switch_on_uint.tmp.1 -> -12,
          switch_on_uint.tmp.2 -> -16,
        }}};
